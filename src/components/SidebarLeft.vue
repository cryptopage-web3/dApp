    ...
    <div class="main-left">
        <header class="sidebar">
            <div class="sidebar-top">
                ...
                <ul class="menu">
                    ...
                    <li class="d-sm-none">
                        <router-link to="/" exact-active-class="" active-class="" exact>
                            <div>
                                <svg viewBox="0 0 24 24" aria-hidden="true" class="r-14j79pv r-4qtqp9 r-yyyyoo r-lwhw9o r-dnmrzs r-bnwqim r-1plcrui r-lrvibr"><g><path d="M21.53 20.47l-3.66-3.66C19.195 15.24 20 13.214 20 11c0-4.97-4.03-9-9-9s-9 4.03-9 9 4.03 9 9 9c2.215 0 4.24-.804 5.808-2.13l3.66 3.66c.147.146.34.22.53.22s.385-.073.53-.22c.295-.293.295-.767.002-1.06zM3.5 11c0-4.135 3.365-7.5 7.5-7.5s7.5 3.365 7.5 7.5-3.365 7.5-7.5 7.5-7.5-3.365-7.5-7.5z"></path></g></svg>
                            </div>
                        </router-link>
                    </li>
                    <li class="d-sm-block d-none">
                        <router-link to="/explore" exact-active-class="" active-class="" exact>
                            <div>
                    ...
                    <li>
                        <router-link to="/notifications" exact-active-class="" active-class="" exact>
                            <div>
                    ...
                    <li>
                        <router-link to="/messages" exact-active-class="" active-class="" exact>
                            <div>
                    ...
                    <li class="d-xl-none d-sm-block d-none">
                        <router-link to="/" exact-active-class="" active-class="" exact>
                            <div>
                    ...
                    <li class="d-sm-block d-none">
                        <router-link to="/profile" exact-active-class="" active-class="" exact>
                            <div>
                    ...
                    <li class="d-sm-block d-none">
                        <router-link to="/more" exact-active-class="" active-class="" exact>
                            <div>
                ...
                <router-link to="/" exact-active-class="" active-class="" class="sidebar-tweet" exact>
                    <span>Tweet</span>
            ...
            <div class="sidebar-profile">
                <router-link to="/" exact-active-class="" active-class="" class="sidebar-profile__link" exact>
                    <div>
                    <div class="sidebar-profile__thumb" :style="{ backgroundImage: 'url(' + require('@/assets/img/sidebar-profile__link_img1.png') + ')'}"></div>
                    <span>
                        <mark>Crypto-Twitter</mark><br>
                        @cryptotwitter
                    </span>
                    </div>
