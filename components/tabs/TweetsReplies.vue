<template>
  <div class="posts">
    <div class="post">
      <div class="post-cont">
        <a
          ...
          :style="{
            backgroundImage:
              'url(' + require('@/assets/img_old/post-logo_img6.jpg') + ')'
          }"
        ></a>
        <div class="post-right">
          <div class="post-account">
            <div class="post-account-left">
              ...
              @elonmusk ·
              <a href="#" class="post-account__date"> Jul 21 </a>
            </div>
    ...
    <div class="post">
      ...
      <div class="post-cont">
        ...
        <div class="post-right">
          ...
          <div class="post-title">
            Dragon has autonomously re-docked with the
            <a href="#">@Space_Station</a>
          </div>
    ...
    <div class="post">
      ...
      <div class="post-cont">
        ...
        <div class="post-right">
          ...
          <div class="post-title">
            LIVE: The <a href="#">@SpaceX</a> Crew Dragon Endeavour, with four
            astronauts aboard, relocates from the forward-facing port of the
            <a href="#">@Space_Station</a> 's Harmony module to its space-facing
            port. Watch:
          </div>
          <div class="post-videos">
            <div class="post-video">
              <div class="video">
                <div
                  class="video-preview"
                  style="
                    background-image: url('https://pbs.twimg.com/ext_tw_video_thumb/1416663646445445122/pu/img/R7slNfB2DIxE8nKU.jpg');
                    display: none;
                  "
                >
                  ...
                  <div class="video-slider">
                    <div class="video-slider-container" style="">
                      <div class="video-slider-bg">
                        <div
                          class="video-slider-rail"
                          style="width: 0.0424863%"
                        ></div>
                        <div
                          class="video-slider-buffer"
                          style="left: -0.957514%"
                        ></div>
                      </div>
                    </div>
                ...
                <div
                  class="video-contextMenu"
                  style="display: none; top: 1434px; left: 874px"
                >
            ...
            <div class="post-videos-bottom">
              <div class="post-account-left">
                <a href="#" class="post-account__link">
                  <div
                    class="post-account__link_img"
                    style="
                      background-image: url('img/0ZxKlEKB_normal.post-logo_img6.jpg');
                    "
                  ></div>
                  <span> NASA </span>
                  <svg
    ...
    <div class="post-follows">
      <div class="post-follows-zag">Who to follow</div>
      <div class="post-follow">
        ...
        <div class="post-follow-right">
          <div class="post-follow-top">
            ...
            <a
              href="#"
              class="post-follow-top__link btn btn_blue btn_transparent"
            >
              Follow
            </a>
          </div>
    ...
    <div class="post-topics">
      <div class="post-topics-top">
        <div class="post-topics-top__title">Topics to follow</div>
      ...
      <div class="post-follow-bottom">
        <a href="#" class="post-follow-bottom__link"> More Topics </a>
      </div>
    </div>
    <div class="post">
      <a href="#" class="post-retweeted">
        ...
        <div class="post-right">
          <div class="post-account">
            <div class="post-account-left">
              ...
              @Tesla ·
              <a href="#" class="post-account__date"> Jul 18 </a>
            </div>
            <div class="post-account-right">
              <a href="#">
                <svg
          ...
          <div class="post-title">
            Solar Roof is designed to withstand heavy storms, hail and even
            medium-size tree branches
          </div>
          <div class="post-youtube">
            <a
              href="https://www.youtube.com/watch?v=kYtUCTj3gAA"
              target="_blank"
              class="post-youtube__link"
            >
              <div
                class="post-youtube-left"
                :style="{
                  backgroundImage:
                    'url(' +
              ...
              <div class="post-youtube-right">
                ...
                <div class="post-youtube-right__text">
                  This video showcases an actual case study of what happens when
                  the glass Tesla Solar Roof is ...
                </div>
