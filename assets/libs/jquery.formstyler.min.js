...
!(function (e) {
  ...
  function s(t) {
    if (
      ...
      const s = e('div.jq-selectbox.opened')
      const l = e('div.jq-selectbox__search input', s)
      const o = e('div.jq-selectbox__dropdown', s)
      s
        .find('select')
        .data('_' + i)
      ...
      if (i.is(':checkbox')) {
          ...
          i.after(l).prependTo(l),
            ...
            l.click(function (t) {
              if (
                ...
                const s = e('input[name="' + i.attr('name') + '"]')
                s
                  .commonParent()
                  .find(s)
                  .prop('checked', !1)
        ...
        const n = function () {
          ...
          const n = function (t) {
            ...
            const r = (d.toString().split('.')[1] || []).length
            if (r > 0) {
        ...
        const f = function () {
          function d(e) {
            const t = e.prop('scrollHeight') - e.outerHeight()
            let s = null
            let i = null
          ...
          if (i.is('[multiple]')) {
            ...
            !(function () {
              const s = new t()
              const l = e('<div class="jq-select-multiple jqselect"></div>')
                .attr({ id: s.id, title: s.title })
                .addClass(s.classes)
                .data(s.data)
              ...
              const a = e('li', l)
              const f = i.attr('size')
              const h = o.outerHeight()
              const u = a.outerHeight()
              void 0 !== f && f > 0
                ? o.css({ height: u * f })
                : o.css({ height: 4 * u }),
                h > l.height() &&
                  ...
                  : (a
                    ...
                    h > l.height() &&
                      i.on('keydown.styler', function (e) {
                        ;(e.which != 38 && e.which != 37 && e.which != 33) ||
                          o.scrollTop(
                            o.scrollTop() +
                              a.filter('.selected').position().top -
                              u
                          ),
                          (e.which != 40 && e.which != 39 && e.which != 34) ||
                            o.scrollTop(
                              o.scrollTop() +
            ...
            !(function () {
              const a = new t()
              let f = ''
              let h = i.data('placeholder')
              let u = i.data('search')
              let p = i.data('search-limit')
              let v = i.data('search-not-found')
              let m = i.data('search-placeholder')
              let g = i.data('smart-positioning')
              ...
              let C = b.css('z-index')
              C = C > 0 ? C : 1
              const x = e('div.jq-selectbox__select', b)
              const y = e('div.jq-selectbox__select-text', b)
              const w = c.filter(':selected')
              r(),
                u &&
                  (f =
              ...
              const j = e('li', q)
              const k = e('input', q)
              const S = e('div.jq-selectbox__not-found', q).hide()
              ...
              if (
                ...
                const P = b.clone().appendTo('body').width('auto')
                const H = P.outerWidth()
              ...
              T > b.width() && q.width(T),
                c.first().text() === '' &&
                  i.data('placeholder') !== '' &&
                  j.first().hide()
              const A = b.outerHeight(!0)
              const D = k.parent().outerHeight(!0) || 0
              const I = _.css('max-height')
              const K = j.filter('.selected')
              if (
              ...
              let M = q.css('top')
              if (
                (q.css('left') == 'auto' && q.css({ left: 0 }),
                q.css('top') == 'auto' && (q.css({ top: A }), (M = A)),
                q.hide(),
                K.length &&
              ...
              x.click(function () {
                if (
                  ...
                  const t = e(window)
                  let s = j.data('li-height')
                  const a = b.offset().top
                  const r = t.height() - A - (a - t.scrollTop())
                  let n = i.data('visible-options')
                  ;(void 0 !== n && n !== '') || (n = l.selectVisibleOptions)
                  let f = 5 * s
                  let h = s * n
                  n > 0 && n < 6 && (f = h), n === 0 && (h = 'auto')
                  const u = function () {
